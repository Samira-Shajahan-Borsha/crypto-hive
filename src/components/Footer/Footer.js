    ...
    return (
      ...
      <div className='max-w-screen-xl mx-auto px-4'>
        <div className=' flex max-w-xs mx-auto items-center justify-between'>
          <a
            href='https://github.com/Samira-Shajahan-Borsha'
            className='text-gray-400 hover:text-gray-800 transition-colors duration-200'  target="_blank"  rel="noreferrer"
          >
            <svg
              width='20'
              height='20'
        ...
        <div className='text-center text-cyan-600 pt-10 sm:pt-12 font-light flex items-center justify-center'>
          All Rights Reserved By &copy; Crypto Hive | 2022-2026
        </div>
      </div>
    </footer>
        </div>
